...
// are.
//
// Measured off these frames: with the strip the page's topmost paint is row 44 of
...
// window's own top edge, the search field paints inside the run the platform's
